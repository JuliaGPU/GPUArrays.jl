...
a = GPUArray(zeros(Float32, 50, 50), glctx, usage=GL_DYNAMIC_DRAW)
...
tex = GPUArray(Texture(zeros(Float32, 50, 50), minfilter=:nearest, x_repeat=:clamp_to_edge), (50,50), glctx)
